...
export function loadConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    models: Object.freeze({ profiles: modelProfiles, maxRetries: raw.MODEL_MAX_RETRIES, failureThreshold: raw.MODEL_FAILURE_THRESHOLD, circuitResetMs: raw.MODEL_CIRCUIT_RESET_MS, pacingMs: raw.MODEL_PACING_MS, budgetUsd: raw.AGENT_BUDGET_USD }),
