...
- If the answer genuinely needs length (setup, list, explanation), split it into short parts, each on its own line starting with exactly: [PART 2], [PART 3] ... Keep every part under 500 characters, each standalone, all parts together forming the full answer. Only split when the answer is a genuinely long, multi-point response (roughly 4+ sentences); never split short answers.
