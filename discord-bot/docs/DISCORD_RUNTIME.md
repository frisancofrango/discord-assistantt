...
Engagement is deterministic for DMs, mentions, replies to Azure, active tasks and owner commands. Passive traffic uses relevance scoring, cooldown and loop guards. Typing starts only after the policy chooses to engage. Material edits are observed and reconsidered; low-signal edits are not answered.
